...
public class Dipendente {
	...
	public Boolean Ingresso(String motivazione, Date orario) {
		if (badgeSospeso) {
			return false;
		} else {
	...
	public Boolean Uscita(String motivazione, Date orario) {
		if (badgeSospeso) {
			return false;
		} else {
...
class IngressoUscita {
	...
	public IngressoUscita(Boolean ingresso, String motivazione, Date orario) {
		super();
